...
$$
x_t = x_{t-1} + u + w_t ~ \text{with} ~ w_t \sim N(0,q)
$$
...
plot.ts(yy, ylim = range(xx,yy), type = "n",
        ylab = expression(italic(x[t])))
## x_{t-1} + u + w_t
lines(c(2, 2), c(xx[1], xx[2]) + uu, lwd = 2, type = "o", pch = 16, col = "black")
## x_{t-1} + u
lines(c(xx[1], xx[1] + uu), lwd = 2, type = "o", pch = 16, col = "black")
## x_1
points(xx[1], pch = 16, col = "gray")
```
...
## y_t = x_t + v_t
lines(c(2, 2), c(yy[2], xx[2] + uu), lwd = 2, type = "o", pch = 16, col = "black")
## x_{t-1} + u + w_t
lines(c(2, 2), c(xx[1], xx[2]) + uu, lwd = 2, type = "o", pch = 16, col = "gray")
## x_{t-1} + u
lines(c(xx[1], xx[1] + uu), lwd = 2, type = "o", pch = 16, col = "gray")
## x_1
points(xx[1], pch = 16, col = "gray")
```
...
plot.ts(yy, ylim = range(xx,yy), type = "n",
        ylab = expression(italic(y[2])))
## x_{t-1} + w_t
lines(c(2, 2), c(yy[2], xx[2]), lwd = 2, type = "o", pch = 16, col = "gray")
## x_{t-1} + w_t
lines(c(2, 2), c(xx[1], xx[2]), lwd = 2, type = "o", pch = 16, col = "gray")
## x_1
lines(c(xx[1], xx[1]), lwd = 2, type = "o", pch = 16, col = "gray")
## x_1
points(xx[1], pch = 16, col = "gray")
```
...
segments(seq(2, TT), y0 = xx[-1], y1 = xx[-TT], lwd = 3, col = "red")
segments(seq(2, TT), y0 = xx[-1], y1 = yy[-1])
```
